...
<body class="flex justify-center bg-zinc-50 sm:px-8 lg:px-12">
  <div class="w-full bg-white max-w-7xl">

    <!-- TopNav -->
    <div class="px-4 sm:px-8 lg:px-12">
      <header class="relative flex items-start pt-6">
        <!-- Ava -->
        <a href="/" class="pointer-events-auto">
          <img src="<?= get_template_directory_uri() ?>/assets/images/me.jpg" alt="Valery Pronin Ava" class="block object-cover object-center w-10 h-10 rounded-full shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5">
        </a>
        <!-- MobileOnly -->
