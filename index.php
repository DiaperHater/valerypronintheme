...
<!-- Testimonial -->
<section class="px-4 py-24 mt-24 sm:py-32 lg:py-40 sm:mt-32 lg:mt-40 sm:px-8 lg:px-12 bg-neutral-50">
  <figure class="max-w-5xl mx-auto">
    <blockquote class="relative text-3xl font-medium tracking-tight font-display text-zinc-800 sm:text-4xl">
    ...
    <figcaption class="mt-10">
      <img alt="ClientName" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" src="<?= get_template_directory_uri() ?>/assets/images/client-logo.svg" class="">
    </figcaption>
  </figure>
...
<!-- CTA -->
<section class="px-6 mx-auto mt-24 max-w-7xl lg:px-8 sm:mt-32 lg:mt-40">
  <div class="max-w-2xl mx-auto lg:max-w-none">
    <div class="px-6 py-20 -mx-6 rounded-3xl bg-neutral-950 sm:mx-0 sm:py-32 md:px-12">
      <div class="max-w-4xl mx-auto">
        <div class="max-w-xl">
          ...
          <div class="pt-10 mt-10 border-t border-white/10">
            <h3 class="text-base font-semibold text-white font-display">Contacts</h3>
            <ul role="list" class="grid grid-cols-1 gap-8 mt-6 sm:grid-cols-2">
              <li>
                <span class="text-sm not-italic text-neutral-300">
                  ...
                  <br><a href="tel:+375259875947" class="">+375 (25) 987-59-47</a>
                </span>
              </li>
              <li>
                <span class="text-sm not-italic text-neutral-300">
                  <strong class="text-white">Email</strong>
                  <br><a href="mailto:one@valerypronin.com" class="">one@valerypronin.com</a>
                </span>
              </li>
            </ul>
          </div>
