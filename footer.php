    ...
    <div class="relative px-4 sm:px-8 lg:px-12">
      <div class="max-w-2xl mx-auto lg:max-w-5xl">
        <div class="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div class="flex flex-wrap justify-center text-sm font-medium gap-x-6 gap-y-1 text-zinc-800 dark:text-zinc-200">
          ...
          <p class="text-sm text-zinc-400 dark:text-zinc-500">© <!-- --><?php echo date("Y"); ?><!-- --> Valery Pronin. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
