...
<div class="px-6 mx-auto mt-32 max-w-7xl lg:px-8 sm:mt-40 lg:mt-64">
  <div class="max-w-2xl mx-auto lg:max-w-none">
    <div>
      <h1>
        <span class="block text-base font-semibold font-display text-zinc-800">
          My work
        </span>
...
<!-- Work -->
<div class="px-6 mx-auto mt-40 max-w-7xl lg:px-8">
  <div class="max-w-2xl mx-auto lg:max-w-none">
    <div>
      <h2 class="text-2xl font-semibold font-display text-zinc-800">
        Case studies
      </h2>
    </div>
        ...
        <article>
          <div class="relative grid grid-cols-3 pt-16 gap-x-8 gap-y-8 before:absolute after:absolute before:bg-zinc-800 after:bg-zinc-800/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
            ...
            <div class="col-span-full lg:col-span-2 lg:max-w-2xl">
              ...
              <div class="flex mt-8">
                <!-- <a class="inline-flex rounded-full px-4 pt-1.5 pb-2.5 text-sm font-semibold transition bg-zinc-800 text-white hover:bg-neutral-800" href="/work">
              ...
              <!-- <div class="relative pl-8 mt-12 before:absolute after:absolute before:bg-zinc-800 after:bg-zinc-800/10 before:left-0 before:top-0 before:h-6 before:w-px after:bottom-0 after:left-0 after:top-8 after:w-px">
                <figure class="text-sm">
                  ...
                  <figcaption class="mt-6 font-semibold text-zinc-800">
        ...
        <article>
          <div class="relative grid grid-cols-3 pt-16 gap-x-8 gap-y-8 before:absolute after:absolute before:bg-zinc-800 after:bg-zinc-800/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
            ...
            <div class="col-span-full lg:col-span-2 lg:max-w-2xl">
              ...
              <div class="flex mt-8">
                <!-- <a class="inline-flex rounded-full px-4 pt-1.5 pb-2.5 text-sm font-semibold transition bg-zinc-800 text-white hover:bg-neutral-800" aria-label="Read case study: Unseal" href="/work">
                  <span class="relative top-px">
                    Read case study
                  </span> -->
                </a>
        ...
        <article>
          <div class="relative grid grid-cols-3 pt-16 gap-x-8 gap-y-8 before:absolute after:absolute before:bg-zinc-800 after:bg-zinc-800/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
            ...
            <div class="col-span-full lg:col-span-2 lg:max-w-2xl">
              ...
              <div class="flex mt-8">
                <!-- <a class="inline-flex rounded-full px-4 pt-1.5 pb-2.5 text-sm font-semibold transition bg-zinc-800 text-white hover:bg-neutral-800" aria-label="Read case study: Phobia" href="/work">
                  <span class="relative top-px">
                    Read case study
                  </span> -->
                </a>
